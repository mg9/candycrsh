...
public class RemoveTester {
	private static RemoveTester instance = new RemoveTester();
	private static BoardCell[][] localBoardMap = new BoardCell[0][0];
	private static String removeType;

	private RemoveTester() {

	}

	public static void setRemoveLocalMap(BoardCell[][] map) {
		localBoardMap = map;
	}

	public static RemoveTester getInstance() {
		return instance;
	}
	...
	public static Boolean removeforSingleCell(BoardCell cell) {
		Boolean result = true;
	...
	private static void removeColorBombvsColorBomb(BoardCell cell1,
		...
		System.out.println("Color Bomb vs ColorBomb Remove Detected!!");
	}
	...
	private static void removeStripedvsWrapped(BoardCell striped,
		...
		System.out.println("Striped vs Wrapped Remove Detected!!");
	}
	...
	public static BoardCell[][] getLocalMap(){
		return localBoardMap;
	}
	...
	private static boolean removeThreeVertical(BoardCell cell) {
		...
		if (canRemoveThreeVertical) {
			System.out.println("Remove three vertical detected for x="
					+ cell.getCellX() + " y=" + cell.getCellY());
	...
	private static boolean removeThreeHorizontal(BoardCell cell) {
		...
		if (canRemoveThreeHorizontal) {
			System.out.println("Remove three horizontal detected for x="
					+ cell.getCellX() + " y=" + cell.getCellY());
	...
	private static boolean removeFourVertical(BoardCell cell) {
		...
		if (canRemoveFourVertical) {
			System.out.println("Remove four vertical detected for x="
					+ cell.getCellX() + " y=" + cell.getCellY());
	...
	private static boolean removeFourHorizontal(BoardCell cell) {
		...
		if (canRemoveFourHorizontal) {
			System.out.println("Remove four horizontal detected for x="
					+ cell.getCellX() + " y=" + cell.getCellY());
	...
	private static boolean removeFive(BoardCell cell) {
		...
		if(canRemoveFive) {
			System.out.println("Remove five detected for x=" + cell.getCellX()
					+ " y=" + cell.getCellY());
		}
	...
	private static boolean removeL(BoardCell cell) {
		...
		if(canRemoveL) {
			System.out.println("Remove L detected for x=" + cell.getCellX() + " y="
					+ cell.getCellY());
		}
		return canRemoveL;
	...
	private static boolean removeT(BoardCell cell) {
		...
		if(canRemoveT) {
			System.out.println("Remove T detected for x=" + cell.getCellX() + " y="
					+ cell.getCellY());
		}
		return canRemoveT;
	}
		...
		if (cell != null && cell.hasLokum()) {
			if (cell.getCellLokum().type.equals("Striped")) {
				...
				if (GameEngine.isTimeBasedGame
						&& cell.getCellLokum().isTimerLokum()) {
					System.out.println("A timer lokum exploded. It added "
							+ cell.getCellLokum().getTimeOfLokum()
							+ "seconds to the game");
					GameEngine.increaseTime(cell.getCellLokum()
							.getTimeOfLokum());
